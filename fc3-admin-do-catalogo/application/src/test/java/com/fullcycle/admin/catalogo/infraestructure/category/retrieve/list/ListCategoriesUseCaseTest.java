package com.fullcycle.admin.catalogo.infraestructure.category.retrieve.list;

import com.fullcycle.admin.catalogo.infraestructure.category.retrive.list.CategoryListOutput;
import com.fullcycle.admin.catalogo.infraestructure.category.retrive.list.DefaultListCategoriesUseCase;
...
class ListCategoriesUseCaseTest {
    ...
    void givenAValidQuery_whenHasNoResults_thenShouldReturnEmptyCategories() {
       ...
       verify(categoryGateway).findAll(aQuery);
    }
